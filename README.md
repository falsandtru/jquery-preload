...
クリックから表示までにかかった時間をコンソールに出力します。以下の出力はクリックの380ミリ秒前にリンク先のページの取得を開始し、クリックから443ミリ秒で表示されたときのものです。

```
[-380, 1, 382, 423, 443, 452, 483, 483, 485]
["preload(-380)", "continue(1)", "loaded(382)", "head(423)", "content(443)", "css(452)", "script(483)", "renderd(483)", "defer(485)"]
```
