...
module.exports = function (config) {
  ...
  config.set({
    ...
    files: [
      // dependencies
      { pattern: 'test/lib/*.js', watched: false, served: true, included: true },
      { pattern: 'src/**/*.js', watched: false, served: true, included: false },
      ...
      { pattern: 'test/cov/*.js', watched: true, served: true, included: true }
    ],
